...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_submenus__ = __webpack_require__(14);
...
(function ($) {
   ...
   MegaMenu.attr('id', 'megamenu').attr('aria-hidden', true).attr('aria-expanded', false);
...
(function ($) {
	...
	var MainMenu = $('nav.main:not(.mobileNav__nav)');
	...
	MenuLinksWithChildren.after(ButtonHTML).attr('aria-expanded', false).attr('aria-haspopup', true);
	...
	function submenuToggleHandler() {
		...
		CurrentSubmenu.slideToggle(350, 'swing').attr('aria-hidden', newAriaHiddenState);
	...
	$('#menu-main').on('mouseenter focusin', '.sub-menu', function (e) {
		var Current = $(this);
		...
		setTimeout(function () {
			if (ActiveSubmenu.find(':focus').length) {
				...
				ActiveSubmenu.slideToggle(350, 'swing', function () {
