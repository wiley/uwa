...
//
__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.js__menu-trigger').on('click', function (e) {
  e.preventDefault();

  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').toggleClass('mobileNav--active');
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.mobileNav').toggleClass('visible');
});
...
(function ($) {
   ...
   NavDegreesItem.addClass('menu-item-has-children').attr('tabindex', 0);

   NavDegreesLink.after(content);
   var MegaMenu = $('nav.main:not(.mobileNav__nav) .degrees-menu');

   MegaMenu.attr('id', 'megamenu').attr('aria-hidden', true).attr('aria-labelledby', true).attr('aria-expanded', false);
...
(function ($) {
  ...
  function toggleSubmenus() {
    var Button = $(this);
    var ParentItem = Button.parent('.menu-item-has-children');
    ...
    Submenu.addClass('activeSubmenu').slideToggle(350, 'swing');
