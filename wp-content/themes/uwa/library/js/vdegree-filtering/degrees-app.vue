<template>
  <div id="degrees-app">
      ...
      <div class="filter-group filters-types">
        ...
        >
          ...
          >
            <img
              key="arrow-down"
              v-if="mobileMode && !showDegreeTypesToolbar"
              src="/wp-content/themes/uwa/library/images/filtering-module/arrow-down-red.svg"
              alt=""
            >
            <img
              key="arrow-down"
              v-else-if="mobileMode && showDegreeTypesToolbar"
              src="/wp-content/themes/uwa/library/images/filtering-module/arrow-up-red.svg"
              alt=""
            >
          </transition>
          <transition name="icon-switch">
            <span
              @click="$store.activeDegreeType = 'all'"
              class="desktop-clear"
              v-if="!mobileMode && $store.activeDegreeType != 'all'"
            >
              <img
                key="clear"
                src="/wp-content/themes/uwa/library/images/filtering-module/clear-search-red.svg"
                alt="Clear Search"
              >
              Clear
            </span>
      ...
      <div class="filter-group filters-areas">
        ...
        >
          ...
          >
            <img
              key="arrow-down"
              v-if="mobileMode && !showDegreeAreasToolbar"
              src="/wp-content/themes/uwa/library/images/filtering-module/arrow-down-red.svg"
              alt=""
            >
            <img
              key="arrow-down"
              v-else-if="mobileMode && showDegreeAreasToolbar"
              src="/wp-content/themes/uwa/library/images/filtering-module/arrow-up-red.svg"
              alt=""
            >
          </transition>
          <transition name="icon-switch">
            <span
              @click="$store.activeDegreeArea = 'all'"
              class="desktop-clear"
              v-if="!mobileMode && $store.activeDegreeArea != 'all'"
            >
              <img
                key="clear"
                src="/wp-content/themes/uwa/library/images/filtering-module/clear-search-red.svg"
    ...
    <div class="sticky-grid">
      <transition-group
        tag="ul"
        class="sticky degree-grid degrees"
        name="list"
      >
        <degree-item
...
const devUrl = "https://uwa-gulp.loc";
...
var wp = new WPAPI({ endpoint: `${apiUrl}/wp-json` });

wp.degrees = wp.registerRoute("wp/v2", `/degrees/(?P<id>\\d+)`);
