...
(function($) {
  ...
  function toggleSubmenus() {
    ...
    let ParentID = ParentItem.attr('id')
    ...
    if (Submenu.hasClass('activeSubmenu')) {
      ...
      MainMenu.on('keyup', function(keyEvent) {
        if (keyEvent.which == Keys.TAB) {
          var focusedElement = $(document.activeElement)
          var focusedElementID = focusedElement.attr('id')
          // console.log(focusedElementID);
          console.log('Active', focusedElement.hasClass('menu-item-has-children'));
          console.log(ParentID);
          if (Submenu.find(focusedElement).length === 0 ) {
            // console.log(Submenu);
            // console.log(Submenu.hasClass('activeSubmenu'));
            Submenu.slideToggle(350, 'swing', function() {
        ...
        // if (focused.parents('.drop.user-menu').length === 0) {
