...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
    ...
    <?php if ( is_front_page() ) { ?> <style><?php include 'library/css/build/minified/home-critical.css'; ?></style><?php } ?>
		...
		<script>loadCSS( "/wp-content/themes/uwa/library/css/build/minified/style.css" );</script>
		...
		<div id="container" class="container">
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div class="wrap cf">
					...
					<p class="logo header__logo h1" itemscope itemtype="http://schema.org/Organization"><a href="<?php echo home_url(); ?>" rel="nofollow"><img src="/wp-content/uploads/2017/01/uwa-logo.svg" alt="The University of West Alabama Logo"></a></p>

					<?php /* <a class="button header__button js__menu-trigger" href="#">Menu</a> */ ?>

					<?php /* <nav class="header__nav" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
