<div class="affording">
  <div class="wrap cf">
    <h2 class="affording__heading">Affording Your Education</h2>
    <p>The University of West Alabama Online is dedicated to making your education as affordable as possible. Discover what it will cost — and how much you’ll save.</p>
    <div class="section">
      <div class="card">
    ...
    <div class="section">
      <div class="card">
        ...
        <div class="card__info">
          ...
          <a href="/financial-aid" class="btn__hollow">Financial Info</a>
        </div>
      </div>
      <div class="fastFact">
        <h6 class="fastFact__heading"><?php include('lighting.svg'); ?>Fast Fact</h6>
