<div class="accreditations">
  <?php if (get_field('sacs_logo')): ?>
    <a href="http://sacs.org" target="_blank" rel="noopener"><img src="/wp-content/themes/uwa/library/images/accreditations/1.png" alt="accreditation logo"></a>
  <?php endif; ?>
  <?php if (get_field('alsde_logo')): ?>
  ...
  <?php endif; ?>
  <?php if (get_field('oer_logo')): ?>
    <a href="#oer_module" target="_blank" rel="noopener"><img src="/wp-content/uploads/2019/02/OER-Badge-Vert-UWA.png"></a>
  <?php endif; ?>
</div>
